...
const Sidebar = () => {
  ...
  return (
    <div
      ...
      } max-lg:fixed z-10 bg-background flex flex-col items-center justify-between w-[240px] h-full py-4 px-3.5 border-r border-tokena-gray dark:border-border transition-transform duration-300 overflow-y-auto overflow-x-hidden`}
    >
