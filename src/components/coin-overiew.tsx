  ...
  return (
    <>
      <div
        ...
        } bg-background w-[315px] xs:w-[365px] md:w-[496px] space-y-[26px] rounded-2xl overflow-y-auto p-5 fixed right-3 top-3 h-full z-20 transition-transform duration-300 ease-linear`}
      >
        {isLoading ? (
            ...
            <div className="space-y-[26px]">
              ...
              <ul className="space-y-1.5">
                ...
                <li className="flex items-center justify-between">
                  ...
                  <span className="font-medium text-tokena-dark-gray text-xs xs:text-sm dark:text-tokena-gray">
                    {formatCurrency(
                      Number(coinDetails.market_data.high_24h.usd)
                    )}
                  </span>
                </li>
                <li className="flex items-center justify-between">
                  ...
                  <span className="font-medium text-tokena-dark-gray text-xs xs:text-sm dark:text-tokena-gray">
                    {formatCurrency(
                      Number(coinDetails.market_data.low_24h.usd)
                    )}
                  </span>
                </li>
              </ul>
      ...
      {isOverviewOpen && (
        <div className="fixed inset-0 bg-black/25 z-[11]"></div>
      )}
    </>
  );
};
